/**
 * Component Generator for AIOS-FULLSTACK
...
const ElicitationEngine = require('./elicitation-engine');
// const ComponentPreview = require('./component-preview'); // Archived in utils-archive/ (Story 3.1.2)
// const ManifestPreview = require('./manifest-preview'); // Archived in utils-archive/ (Story 3.1.3)
  ...
  processAnswersToVariables(componentType, answers) {
    ...
    switch (componentType) {
      ...
      case 'task':
        ...
        // Notes
        variables.EACH_NOTES = ['Generated using AIOS-FULLSTACK template system'];
        break;
      ...
      case 'workflow':
        ...
        // Metadata
        variables.AUTHOR = process.env.USER || 'AIOS-FULLSTACK';
